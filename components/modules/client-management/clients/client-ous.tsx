...
export const ClientOuTable = ({
  ...
  const ou = trpc.clients.getOu.useQuery({ clientId: clientTemplateId })
  // * hook
  const utils = trpc.useUtils()

  const removeOu = trpc.clients.removeOu.useMutation()
    ...
    removeOu.mutateAsync(
      ...
      },
      {
        onSuccess: async (data) => {
          ...
          await utils.clients.getOu.invalidate({ clientId: clientTemplateId })
        },
        onError(error) {
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem asChild>
                <Link href={`/clients/${clientTemplateId}/ou/${ou?.id}`}>
